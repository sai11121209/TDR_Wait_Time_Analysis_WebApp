...
urlpatterns = [
    ...
    path(
        ...
        cache_page(60 * 15)(views.AttractionList.as_view()),
        name="attractionlist",
    ),
    path(
        "<str:park_type>/<str:attraction_name>/<int:facility_code>/attractiondetail",
        cache_page(60 * 15)(views.AttractionDetail.as_view()),
